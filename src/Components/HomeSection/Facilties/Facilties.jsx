    ...
    return (
        <div className='my-28 px-20'>
            ...
            <div className='grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 mt-20 gap-10'>
                ...
                <div className='f text-center shadow-md px-10 py-10 border-0 hover:bg-warning hover:text-white'>
